...
# custom alba with confidence level suggested by the llm LLM as a judge
    def suggest_relationship(
        ...
        while not success:
            try:
                ...
                # Extract confidence score regardless of the answer
                if confidence_level:
                    confidence_match = re.findall(r"<confidence>(.*?)</confidence", output)
                    if confidence_match:
                        try:
                ...
                if ask_reference is False:
                    if confidence_level:
                        return suggested_relationship, confidence_score
                    return suggested_relationship
                    ...
                    if confidence_level:
                        return suggested_relationship, confidence_score, reference
                        return suggested_relationship, confidence_score, reference
    ...
    def _build_relationship_program(
        ...
        if confidence_level:
            confidence_instruction = " Also provide a confidence score between 0 and 1 within <confidence></confidence> tags, regardless of whether the answer is Yes or No."
    ...
    {description_b}? Answer Yes or No."""
                ...
                if ask_reference:
                    user_prompt = f"""At each step, each expert include a reference to a research paper that supports 
                        ...
                        the answer within the tags, <answer>Yes/No</answer>,{confidence_instruction if confidence_level else ''} and the most influential reference within 
                        the tags <reference>Author, Title, Year of publication</reference>.
                        \n\n\n----------------\n\n\n<answer>Yes</answer>\n<reference>Author, Title, Year of 
                        publication</reference>\n\n\n----------------\n\n\n<answer>No</answer>"""
                    query["user"] += cleandoc(user_prompt)
                else:
                    user_prompt = f"""When consensus is reached, thinking carefully and factually, explain the council's answer. 
                    Provide the answer within the tags, <answer>Yes/No</answer>.{confidence_instruction if confidence_level else ''}
                        \n\n\n----------------\n\n\n<answer>Yes</answer>\n\n\n----------------\n\n\n<answer>No</answer>"""
                    query["user"] += cleandoc(user_prompt)
                ...
                if ask_reference:
                    ...
                    in {variable_a} changes {variable_b}. Answer Yes or No.
                        ...
                        answer within the tags, <answer>Yes/No</answer>,{confidence_instruction if confidence_level else ''} and your references within the tags 
                    ...
                    that you have the right answer. Then provide your final answer within the tags, <answer>Yes/No</answer>.{confidence_instruction if confidence_level else ''}
                        \n\n\n----------------\n\n\n<answer>Yes</answer>\n\n\n----------------\n\n\n<answer>No</answer>"""
                    query["user"] += cleandoc(user_prompt)
                ...
                if ask_reference:
                    ...
                    Provide your final answer within the tags, <answer>Yes/No</answer>,{confidence_instruction if confidence_level else ''} and your references within 
                    the tags <reference>Author, Title, Year of publication</reference. 
                    \n\n\n----------------\n\n\n<answer>Yes</answer>\n<reference>Author, Title, Year of publication</reference>\n\n\n----------------\n\n\n<answer>No</answer>"""
                    query["user"] += cleandoc(user_prompt)
